...
QUnit.test( 'test case of 3/4 "ish"', assert => {
  ...
  ratioTupleProperty.value = ratioTupleProperty.value.withAntecedent( newValue );
  assert.ok( ratioTupleProperty.value.antecedent === 0.308628, 'step up into in-proportion' );

  newValue = snapConserveFunction( 0.318628, ratioTupleProperty.value.antecedent, true, model.inProportionProperty.value );
  ratioTupleProperty.value = ratioTupleProperty.value.withAntecedent( newValue );
...
QUnit.test( 'test case of 1/2 "ish"', assert => {
  ...
  ratioTupleProperty.value = ratioTupleProperty.value.withAntecedent( newValue );
  assert.ok( ratioTupleProperty.value.antecedent === 0.205426, 'utilize remainder' );

  newValue = snapConserveFunction( 0.195426, ratioTupleProperty.value.antecedent, true, model.inProportionProperty.value );
  ratioTupleProperty.value = ratioTupleProperty.value.withAntecedent( newValue );
  ...
  newValue = snapConserveFunction( 0.21, ratioTupleProperty.value.antecedent, true, model.inProportionProperty.value );
  ratioTupleProperty.value = ratioTupleProperty.value.withAntecedent( newValue );
  assert.ok( ratioTupleProperty.value.antecedent === 0.205426, 'step up into ideal' );

  newValue = snapConserveFunction( 0.215426, ratioTupleProperty.value.antecedent, true, model.inProportionProperty.value );
  ratioTupleProperty.value = ratioTupleProperty.value.withAntecedent( newValue );
